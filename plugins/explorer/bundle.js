...
let ExplorerComponent = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      null,
      React.createElement(ExplorerItem, { model: this.props.model, 'class': rootClass })
    );
  }
});
...
},{"./item":35,"react":33}],35:[function(require,module,exports){
var React = require('react');
...
let ExplorerItem = React.createClass({
  ...
  render: function () {
    ...
    var ExplorerItems = this.toArray(this.props.class.relations).map(function (relation) {
      ...
      return React.createElement(ExplorerItem, { key: _class.id, depth: offset + 12, model: model, "class": _class });
    });
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        this.props.class.properties.name
      ),
      React.createElement(
        "div",
        null,
